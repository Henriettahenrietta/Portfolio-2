...
# 📖 Portfolio-2<a name="about-project"></a>
...
**[Portfolio-2]** is an HTML, CSS and Javascript project
...
```sh
  cd Porfolio-structure
  git clone https://github.com/Henriettahenrietta/Portfolio-2.git
```
